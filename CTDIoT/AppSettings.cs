...
namespace CTDIoT
{
    ...
    public class AppSettings
    {
        ...
        const string AlerttypeKeyname = "alert";
        const string MessageKeyname = "m";
        ...
        public string Alerttype
        {
            get
            {
                return GetValueOrDefault<string>(AlerttypeKeyname, AlerttypeDefault);
            }
            set
            {
                if (AddOrUpdateValue(AlerttypeKeyname, value))
                {
                    Save();
                }
            }
        ...
        public string Message
        {
            get
            {
                return GetValueOrDefault<string>(MessageKeyname, MessageDefault);
            }
            set
            {
                if (AddOrUpdateValue(MessageKeyname, value))
                {
                    Save();
                }
            }
